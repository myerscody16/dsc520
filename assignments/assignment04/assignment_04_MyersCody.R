...
ggplot(data=florida_df, aes(x=deaths, y=cases, group=1)) + geom_line()
...
ggplot(data=florida_df, aes(x=" ", group=1)) +
  geom_line(aes(y = cases, colour = "darkred")) +
  geom_line(data=ny_df, aes(y = cases, colour="darkgreen")) +
  geom_line(data=california_df, aes(y = cases, colour="steelblue")) +
  scale_colour_manual("",
